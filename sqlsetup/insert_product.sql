...
-- Coffee
(1, 'Espresso', 'Rich single-origin espresso shot', 2.50, 5, 'espresso.png', TRUE),
(1, 'Caffè Latte', 'Espresso with steamed milk', 4.25, 190, 'latte.png', TRUE),
(1, 'Caramel Macchiato', 'Vanilla syrup with espresso and caramel drizzle', 5.25, 250, 'macchiato.png', FALSE),

-- Tea
(2, 'Matcha Latte', 'Ceremonial-grade matcha with milk', 4.75, 180, 'matcha.png', TRUE),
(2, 'Chai Latte', 'Spiced black tea with steamed milk', 4.50, 240, 'chai.png', FALSE),

-- Breakfast
(3, 'Avocado Toast', 'Sourdough with avocado, chili flakes', 7.50, 320, 'avocado_toast.png', TRUE),
(3, 'Breakfast Sandwich', 'Egg, cheddar & bacon on croissant', 6.75, 450, 'breakfast_sandwich.png', FALSE),

-- Lunch
(4, 'Caprese Panini', 'Mozzarella, tomato & pesto', 8.25, 520, 'caprese.png', TRUE),
(4, 'Chicken Caesar Wrap', 'Grilled chicken with romaine', 8.75, 580, 'caesar_wrap.png', FALSE),

-- Bakery
(5, 'Croissant', 'Buttery French-style', 3.25, 310, 'croissant.png', TRUE),
(5, 'Blueberry Muffin', 'Fresh blueberries in muffin', 3.75, 420, 'blueberry_muffin.png', FALSE),

-- Seasonal Products (added here first)
(6, 'Pumpkin Spice Latte', 'Signature fall drink with spices', 5.95, 380, 'pumpkin_spice.png', TRUE),
(6, 'Peppermint Mocha', 'Holiday chocolate-mint espresso', 5.75, 420, 'peppermint_mocha.png', TRUE),
(6, 'Iced Lavender Latte', 'Floral summer cold brew', 5.25, 210, 'lavender_latte.png', FALSE),
(6, 'Watermelon Mint Tea', 'Refreshing summer cooler', 4.95, 90, 'watermelon_tea.png', FALSE),
(6, 'Gingerbread Cookie', 'Festive molasses spice cookie', 3.50, 280, 'gingerbread.png', TRUE);
