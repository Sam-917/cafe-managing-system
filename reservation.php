...
<body>
            ...
            <div class="col-12 col-lg-8 col-xl-6">
                <div class="glass-card rounded-4 p-4 p-md-5">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div class="d-flex justify-content-center gap-3 text-sm">
                            <span class="text-primary fw-medium">Location</span>
                        ...
                        <div class="bg-white rounded-3 border p-4 mb-4">
                            ...
                            <div class="restaurant-layout position-relative" style="height: 400px; background: #f8f9fa; border-radius: 8px;">
                                ...
                                <div class="<?php echo $classes; ?>" 
                                     ...
                                     style="top: <?php echo rand(80, 320); ?>px; left: <?php echo rand(20, 220); ?>px;">
    ...
    <script>
        ...
        if (selectedDate) {
            document.getElementById('selectedDateDisplay').textContent = formatDate(new Date(selectedDate));
            document.getElementById('selectedDateDisplay2').textContent = formatDate(new Date(selectedDate));
            document.getElementById('summaryDate').textContent = formatDate(new Date(selectedDate));
